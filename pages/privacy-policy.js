function PrivacyPolicy() {
  return (
    <div className="leading-8 p-10">
      ...
      <p>
        Welcome to <b> {"Nat's"} Automated Bot</b>.
      </p>
      <p>
        <b>{"Nat's"} Automated Bot</b> (“us”, “we”, or “our”) operates{" "}
        <b>onihani.vercel.app</b> (hereinafter referred to as <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>onihani.vercel.app</b>, and
      ...
      <p>
        <b>SERVICE</b> means the onihani.vercel.app website operated by{" "}
        {"Nat's"} Automated Bot.
      </p>
      <p>
      ...
      <p>{"Nat's"} Automated Bot uses the collected data for various purposes:</p>
      ...
      <p>
        If you are located outside None and choose to provide information to us,
        please note that we transfer the data, including Personal Data, to None
      ...
      <p>
        {"Nat's"} Automated Bot will take all the steps reasonably necessary to
      ...
      <p>
        ...
        please send your request(s) by email: <b>n.bongo40@gmail.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        by email: <b>n.bongo40@gmail.com</b>.
      </p>
      <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
        This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
        was created for <b>onihani.vercel.app</b> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-06-24.
      </p>
    </div>
  );
}
